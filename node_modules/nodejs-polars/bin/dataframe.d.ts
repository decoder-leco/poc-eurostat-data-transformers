...
/// <reference types="node" />
import { type GroupBy, RollingGroupBy } from "./groupby";
import { type LazyDataFrame } from "./lazy/dataframe";
import { Expr } from "./lazy/expr";
import { Series } from "./series";
import { Writable } from "stream";
import type { FillNullStrategy, JoinOptions, WriteAvroOptions, WriteCsvOptions, WriteIPCOptions, WriteParquetOptions } from "./types";
import { DataType } from "./datatypes";
import { type ColumnSelection, type ColumnsOrExpr, type ExprOrString, type ValueOrArray } from "./utils";
import type { Arithmetic, Deserialize, GroupByOps, Sample, Serialize } from "./shared_traits";
...
export interface DataFrame extends Arithmetic<DataFrame>, Sample<DataFrame>, Arithmetic<DataFrame>, WriteMethods, Serialize, GroupByOps<RollingGroupBy> {
    ...
    distinct(maintainOrder?: any, subset?: any, keep?: any): DataFrame;
    /**
    ...
    pivot(values: string | string[], options: {
        ...
        aggregateFunc?: "sum" | "max" | "min" | "mean" | "median" | "first" | "last" | "count" | Expr;
  ...
  └────────────┴────────┴────────┘
    */
    upsample(timeColumn: string, every: string, offset?: string, by?: string | string[], maintainOrder?: boolean): DataFrame;
    upsample(opts: {
        timeColumn: string;
        every: string;
        offset?: string;
