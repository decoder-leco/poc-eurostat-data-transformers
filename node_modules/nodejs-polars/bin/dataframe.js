    ...
    const df = {
        ...
        *[Symbol.iterator]() {
        ...
        pivot(values, options) {
            let { values: values_, index, columns, maintainOrder = true, sortColumns = false, aggregateFunc = "first", separator, } = options;
            ...
            return (0, exports._DataFrame)(_df.pivotExpr(values, index, columns, fn, maintainOrder, sortColumns, separator));
        },
        quantile(quantile) {
