...
/** @ignore */
export declare function DynamicGroupBy(df: any, indexColumn: string, every: string, period?: string, offset?: string, includeBoundaries?: boolean, closed?: string, by?: ColumnsOrExpr, start_by?: StartBy, check_sorted?: boolean): DynamicGroupBy;
export {};
